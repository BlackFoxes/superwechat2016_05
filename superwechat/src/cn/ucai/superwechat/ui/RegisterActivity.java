...
public class RegisterActivity extends BaseActivity {
    ...
    private void registerAppServer() {
        NetDao.register(this, username, nickname, pwd, new OkHttpUtils.OnCompleteListener<String>() {
            @Override
            public void onSuccess(String result) {
                Result resultFromJson = ResultUtils.getResultFromJson(result, User.class);
                if (resultFromJson != null) {
                    L.e(TAG,"registerAppServer.resultFromJson="+resultFromJson);
                    if (resultFromJson.isRetMsg()) {
                        registerEMServer();
                    } else {
                        pd.dismiss();
                        if (resultFromJson.getRetCode() == I.MSG_REGISTER_USERNAME_EXISTS) {
    ...
    private void unRegisterAppServer() {
        NetDao.unRegister(this, username, new OkHttpUtils.OnCompleteListener<String>() {
            @Override
            public void onSuccess(String result) {
                L.e(TAG, "unRegister.result=" + result);

            }

            @Override
            public void onError(String error) {
                L.e(TAG, "unRegister.error=" + error);
